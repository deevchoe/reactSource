...
import '../App.css'
import pic1 from '../pic2.png';     // 이미지 읽기
// function HookTest() {
//     ...
// }
...
export default function HookTest2() {
    ...
    // 이름이 없는 함수의 주소를 갖고 있는 incrementItem과 decrementItem
    const incrementItem = () => setItem(item + 1);
    const decrementItem = () => setItem(item - 1);

    useEffect(() => {   // 부수 효과(side effects)를 수행하는 데 사용됨.
        let a = 1;
    ...
    return( 
        <div className='App'>
            <div>
                number : {item}&nbsp;
                <button onClick={incrementItem}>증가</button>&nbsp;  {/*incrementItem() : 실행결과 / incrementItem : 실행 */} 
            ...
            {/* 이미지 적용 3 : public 폴더에 있는 파일 */} {/* public 폴더는 아무나 접근할 수 있는 곳이 아니다! */}
            <img src={`${process.env.PUBLIC_URL}/img/pic.png`} alt='public 폴더 이미지 읽기' style={{width: 150, height: 150}} />
        </div>
